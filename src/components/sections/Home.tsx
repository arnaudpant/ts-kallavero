...
const Home: React.FC = () => {
    return (
        <section className="w-full h-screen flex flex-col justify-evenly md:justify-center items-center bg-background"
            id="home">
            <div className="container mx-auto flex flex-col-reverse justify-center items-center gap-10 md:flex-row md:justify-around md:gap-x-8">
                {/* Box Titre */}
                <div className="text-center md:text-left">
                    ...
                    <p className="text-lg pt-4 px-4 md:text-xl md:px-0">
                        ...
                        <br />
                        Développeur React à Nancy, France 🇫🇷
                        <br />
                        Déplacement en région parisienne possible avec remote.
                    </p>
